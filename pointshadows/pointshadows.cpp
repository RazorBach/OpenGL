...
int main() {
	...
	Shader depthShader("pointshadows/depthshader.vs", "pointshadows/depthshader.fs", "pointshadows/depthshader.gs");
	Shader shadowShader("pointshadows/shadow.vs", "pointshadows/shadow.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		depthShader.use();
		// render scene from light's point of viewsimpleDepthShader.use();
		for (unsigned int i = 0; i < 6; ++i)
