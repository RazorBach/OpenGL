...
int main()
{
	...
	Shader shaderRed("advanceGlsl/advance_glsl.vs", "advanceGlsl/red.fs");
	Shader shaderGreen("advanceGlsl/advance_glsl.vs", "advanceGlsl/green.fs");
	Shader shaderBlue("advanceGlsl/advance_glsl.vs", "advanceGlsl/blue.fs");
	Shader shaderYellow("advanceGlsl/advance_glsl.vs", "advanceGlsl/yellow.fs");
