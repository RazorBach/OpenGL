...
int main() {
	...
	Shader lightingShader("light_caster.vs", "mutiple.fs");
	//Shader lightingShader("lightingGouraud.vs", "lightingGouraud.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (circle) {
			lightPos.x = 2.30*sin(0.2*currentFrame);
			lightPos.z = 2.30*cos(0.2*currentFrame);
		}
	...
	/*	lightingShader.setVec3("material.ambient", 1.0f, 0.5f, 0.31f);
		...
		//lightingShader.setVec3("material.specular", 0.4f, 0.7f, 0.7f);
		//lightingShader.setFloat("material.shininess", 0.078125f);
		...
		//lightingShader.setFloat("light.inner", glm::cos(glm::radians(12.5f)));
		//lightingShader.setFloat("light.outer", glm::cos(glm::radians(17.5f)));
		...
		lightingShader.setFloat("spotLight.inner", glm::cos(glm::radians(12.5f)));
		lightingShader.setFloat("spotLight.outer", glm::cos(glm::radians(15.0f)));
